    ...
    return (
        <div>
            <form onSubmit={submitHandler} className="max-w-96 mx-auto mt-50 w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                <h1 class="text-gray-900 text-3xl mt-10 font-medium">Signup</h1>
                <p class="text-gray-500 text-sm mt-2">Please sign in to continue</p>


                <div class="flex items-center w-full mt-5 bg-white border border-gray-300/80 h-12 rounded-full overflow-hidden pl-6 gap-2">

                    <User />
                    <input name='name' value={formData.name} onChange={onChangeHandler} type="text" placeholder="User name" class="bg-transparent text-gray-500 placeholder-gray-500 outline-none text-sm w-full h-full" required />
                </div>
                ...
                <div className='flex items-center w-full mt-4 bg-white border h-10  border-gray-300/80 rounded-full overflow-hidden pl-6 gap-2 '>
                        <select name='role' onChange={onChangeHandler} value={formData.role} className='bg-transparent text-gray-500 placeholder-gray-500 outline-none h-full w-full text-base'>
                ...
                <p class="text-gray-500 text-sm mt-3 mb-11">Already have an account? {" "}
